...
namespace Voidless
{
public class PONGInputController : MonoBehaviour
{
	[SerializeField] private string _pauseID; 				/// <summary>Pause's Input's ID.</summary>
	[SerializeField] private PONGPaddle _paddleA; 			/// <summary>PONGPaddle A.</summary>
	[SerializeField] private PONGPaddle _paddleB; 			/// <summary>PONGPaddle B.</summary>
	[Space(5f)]
...
#region Getters/Setters:
	/// <summary>Gets and Sets paddleA property.</summary>
	...
	/// <summary>Gets and Sets paddleB property.</summary>
	...
	{
		if(paddleA != null) paddleA.Move(leftAxes.y);
		if(paddleB != null) paddleB.Move(rightAxes.y);
	}
